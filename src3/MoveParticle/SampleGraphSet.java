...
public class SampleGraphSet {
	...
	public SampleGraphSet(Dataset training_set, int train_num) {
		SampleGraph g = new SampleGraph(training_set, train_num);
		graph_map.add(g);
		g.InitSampleSet();
		root_graph = g;
	}
	...
	public int NextDayOutput() {
		...
		return SampleGraph.NextDayOutput(graph_map);
	}
