...
public class Wrapper implements EWrapper {
   ...
   // This stores the set of fx-pairs used to store the market data
   protected HashMap<Integer, FXPair> fxpair_map = new HashMap<Integer, FXPair>();
   ...
   public void tickPrice(int tickerId, int field, double price, int canAutoExecute) {
	   ...
	   System.out.println("Price: "+tickerId+" "+field+" "+price);
	   FXPair pair = fxpair_map.get(tickerId);
	   pair.AddTickPrice(field == 2, price);
   ...
   public void tickSize(int tickerId, int field, int size) {
	   ...
	   System.out.println("Volume: "+tickerId+" "+field+" "+size);
	   
	   FXPair pair = fxpair_map.get(tickerId);
	   pair.AddTickVolume(field == 2, size);
   }
   ...
   public void openOrder(int orderId, Contract contract, Order order, OrderState orderState) {
      System.out.println("Order : "+orderId+" "+orderState.m_status+" "+orderState.m_commission+" "+orderState.m_commissionCurrency);
   }
   ...
   public void updateAccountValue(String key, String value, String currency, String accountName) {
      System.out.println("Account: "+key+" "+value+" "+currency+" "+accountName);
      FXPair.UpdateCurrencyValue(key, value, currency);
   }
   ...
   public void updateMktDepth(int tickerId, int position, int operation, int side, double price, int size) {
	   System.out.println("L1 "+tickerId+" "+position+" "+operation+" "+side+" "+price+" "+size);
   }

   public void updateMktDepthL2(int tickerId, int position, String marketMaker, int operation,
      int side, double price, int size) {
	   
	   System.out.println("L2 "+position+" "+operation+" "+side+" "+price+" "+size+" "+marketMaker);
   ...
   public void historicalData(int reqId, String date, double open, double high, double low,
      double close, int volume, int count, double WAP, boolean hasGaps) {
	   ...
	   System.out.println(date+" "+open+" "+high+" "+low+" "+close+" "+volume+" "+count+" "+WAP+" "+hasGaps);
   ...
   private static void attachDisconnectHook(final Wrapper ut) {
