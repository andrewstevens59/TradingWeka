...
public class SampleRfq extends SimpleWrapper {
   ...
   private void submitRfq() {
     ...
     // client().placeOrder(m_rfqId, m_contract,
      ...
      Contract c = new Contract(0, "ALL", "STK", "", (double)0.0, "", "", "SMART", "USD", "", new Vector(), "ISLAND", false, "", "");
      
     // client().reqHistoricalData(1, c, "20130712 08:41:26 GMT", "1 M", "1 day", "BID", 1, 1);
      
      client().reqMktDepth(1, c, 20);
      client().reqMktDepth(2, c, 20);
      client().reqMktDepth(3, c, 20);
     ...
     /* Contract con = new Contract();
      ...
      //client().reqMktDepth(tickerId, con, 20);
   }
   ...
   public static void main(String[] args) {
      try {
         ...
         SampleRfq ut = new SampleRfq(/* clientId */ 0, rfqId, mode);
         ut.testOrder();
      } catch (Exception e) {
         e.printStackTrace();
      }
