...
public class OrderDlg extends JDialog {
    ...
    void onOk() {
        ...
        try {
            ...
            System.out.println("m_order.m_action: " + m_order.m_action);
            System.out.println("m_order.m_totalQuantity: " + m_order.m_totalQuantity);
            System.out.println("m_order.m_orderType: " + m_order.m_orderType);
            System.out.println("m_order.m_lmtPrice: " + m_order.m_lmtPrice);
            System.out.println("m_order.m_auxPrice: " + m_order.m_auxPrice);
            System.out.println("m_order.m_goodAfterTime: " + m_order.m_goodAfterTime);
            System.out.println("m_order.m_goodTillDate: " + m_order.m_goodTillDate);
            System.out.println("m_order.m_faGroup: " + m_order.m_faGroup);
            System.out.println("m_order.m_faProfile: " + m_order.m_faProfile);
            System.out.println("m_order.m_faMethod: " + m_order.m_faMethod);
            System.out.println("m_order.m_faPercentage: " + m_order.m_faPercentage);
            System.out.println("Order ------------------");
