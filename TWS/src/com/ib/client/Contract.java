...
public class Contract implements Cloneable {
    ...
    public void PrintContract() {
    	...
    	System.out.println("m_conId "+m_conId);
    	System.out.println("m_symbol "+m_symbol);
    	System.out.println("m_secType "+m_secType);
    	System.out.println("m_expiry "+m_expiry);
    	System.out.println("m_strike "+m_strike);
    	System.out.println("m_right "+m_right);
    	System.out.println("m_multiplier "+m_multiplier);
    	System.out.println("m_exchange "+m_exchange);
    	System.out.println("m_currency "+m_currency);
    	System.out.println("m_includeExpired "+m_includeExpired);
    	System.out.println("m_localSymbol "+m_localSymbol);
    	System.out.println("m_comboLegs "+m_comboLegs);
    	System.out.println("m_primaryExch "+m_primaryExch);
    	System.out.println("m_secIdType "+m_secIdType);
    	System.out.println("m_secId "+m_secId);
    }
